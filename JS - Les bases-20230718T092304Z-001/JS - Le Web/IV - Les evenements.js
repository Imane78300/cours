...
document.getElementById("child").addEventListener("click", function() { 
  ...
  document.getElementById("child-count").textContent = resultat;
})

/* compteurClic = document.getElementById("parent");

compteurClic.removeEventListener("paret-count", function clic() {
    console.log(compteurClic);
}); */



  compteurClic.stopPropagation();