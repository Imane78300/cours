...
let newElt = document.createElement("div");// <div></div>
 newElt.textContent = "Bonjour "; // <div>Bonjour</div>
 newElt.id='unId',// <div id="unId">Bonjour</div>

document.getElementById("main").appendChild(newElt);
...
/* la on a cree une div avec un id qui conrient letexte bonjour apres on
a demander au parents avec l id maisn de l'a adopter comme un nnoveau enfant*/
...
beforebegin // avant l'élément existant lui-même. ; comme un grand frére 
afterbegin // juste à l'intérieur de l'élément existant, avant son premier enfant. il devient lui le premier enfants 
...
let text =  "<div id="monId">Bonjour</div>";
document.getElementById('main').insertAdjacentHTML("afterBegin" , text);
