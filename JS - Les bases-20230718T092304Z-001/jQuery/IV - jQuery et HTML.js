...
// Si je veux connaitre ce qu'il y a dans le paragraphe et les elements html j'utilise
...
// val() : recupe les  attributs
// attr() : recupere valeur d'un attribut et la modifier aussi 
...
// attr = get atributt  du coup il va rucupputre la valeur de l'attribitt style 
...
// .append() ajoute à la fin comme dernier enfants 
...
// . prepent() ajoute au début comme premier  enfants 
...
// .after() met après la div à l'extérieur !comme frere
...
// .remove() enleve element + son contenu suprumer 

    $('#start').click(function(){
        $('#p1').remove();
    });

// .empty vide le contenu mais ne supprime pas l'élément vider 
