...
let Aurora = {
  ...
  decrire : function(){
    ...
    // en  remplace  le nom de notre variable par this popur faciliter le travaille et en mettent this cela oblige le programme de prendre  ce que en demande
...
return this.arg1 + "est un "   + this.arg2 + "mesurant "   + this.arg3 + "cm"    ; 
