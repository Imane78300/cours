...
let liste = [ "arbre " , "ecureuil" , [7 , 8 , 9 ] ] ;
    liste[2] ; 
...
let liste =["arbre " , "ecureil" , [ 7, 8, 9] ];
   liste [2];
   console.log(liste[2] [2]);
...
// Mon propre Exemple
// Cette méthode marche que sur les tableaux 


let animeaux =["canard  ",  " chat " , "ours "  , "mouton " , "tortu"];

   animeaux.forEach(function (animal ){
   console.log(animal);
...
let MesFruits = [ 'Melon ' , "Pastéque " , "Fraise" , "Banane" , "Orange"];

 MesFruits.splice(2,1);
