...
function refrain(){
  console.log('Dispacito !!!');
 } // Deffinire le refrain comme le enregistrer sont faire play 

 refraine()// rappler le refraine ,  c'est comme un button play


console.log(".....");

 refraine(); // c'est comme un button play 
