<?php error_reporting(0);
        ...
        if( !empty( $_POST ) ){
            ...
            if( !empty( $_POST['websiteName']) && !empty( $_POST['title'] ) && !empty( $_POST['subtitle'] ) ){
                ...
                $table = array("NomDuSite" =>  $_POST['websiteName'], "Titre" => $_POST['title'], "SousTitre" => $_POST['subtitle'], "image" => $_FILES['image']['name'] );
