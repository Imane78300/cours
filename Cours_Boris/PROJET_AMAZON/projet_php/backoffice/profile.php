...
if( $_SESSION['user_statut'] == 0 ){
    //  si je suis utilisateur lambda , je dégage
    header('Location: ../index.php');

}

require_once('lib/db.php');             // fichier qui nous donne accès à la BDD
require_once('lib/user_update.php'); // fichier qui met à jour l'utilisateur connecté
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">avatar</h1> 
                    </div>
