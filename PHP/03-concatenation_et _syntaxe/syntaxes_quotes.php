...
$test = "exemple";
// une variable avec valeur exemple
...
// attention, avec les simples quotes, on doit a chaque foit ytiliser des caractères d'échappements ( antislah \) pour que le code ne soit pas perturbé (faire un test en l'enlevant)
